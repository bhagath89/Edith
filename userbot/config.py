...
class Var(object):
    ...
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://telegra.ph/file/7d79dfe3b10b6058063b0.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/7d79dfe3b10b6058063b0.jpg"
    )
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/7d79dfe3b10b6058063b0.jpg",
    )
