...
#Import Gudz
RUN wget https://raw.githubusercontent.com/ComradeDear/FIGHTERBOT/master/fighterbotrun.py
RUN wget https://raw.githubusercontent.com/ComradeDear/FIGHTERBOT/master/requirements.txt
#Start Fumkin
